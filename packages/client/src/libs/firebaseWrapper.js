...
class FirebaseWrapper {
   ...
   * @param {boolean} mobile if the authentication device is mobile.
   * @param {firebase.auth.AuthProvider} provider The provider to authenticate with.
   */
  ...
  authenticateWithGoogle(mobile = false) {
    return this.authenticate(mobile, new firebase.auth.GoogleAuthProvider());
  }
