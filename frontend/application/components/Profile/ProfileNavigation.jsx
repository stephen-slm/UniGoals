...
export default class ProfileNavigation extends React.Component {
  ...
  submitHelpMessage(e) {
    ...
    help.send(name, email, text)
      .then(result => toaster.success(result.message))
      .then(error => toaster.danger(error.description));
  }
      ...
      <div>
        <nav className="pt-navbar .modifier">
          <div className="pt-navbar-group pt-align-left">
            <div className="pt-navbar-heading">Uni Stats</div>
          </div>
